...
# variable "allow_ai_source_tags" {
#   description = "Source tags for AI firewall"
#   type        = list(string)
# }
...
# # CDN variables
# variable "cdn_backend_bucket_name" {
#   description = "Name of the CDN backend bucket"
#   type        = string
#   default     = "dev-ongi-cdn-backend"
# }

# variable "cdn_bucket_name" {
#   description = "Name of the GCS bucket for CDN"
#   type        = string
#   default     = "dev-ongi-cdn-bucket"
# }

# variable "cdn_url_map_name" {
#   description = "Name of the CDN URL map"
#   type        = string
#   default     = "dev-ongi-cdn-url-map"
# }

# variable "cdn_https_proxy_name" {
#   description = "Name of the CDN HTTPS proxy"
#   type        = string
#   default     = "dev-ongi-cdn-https-proxy"
# }

# variable "cdn_ssl_certificate_id" {
#   description = "ID of the SSL certificate for CDN"
#   type        = string
# }

# variable "cdn_global_ip_name" {
#   description = "Name of the CDN global IP"
#   type        = string
#   default     = "dev-ongi-cdn-ip"
# }

# variable "cdn_forwarding_rule_name" {
#   description = "Name of the CDN forwarding rule"
#   type        = string
#   default     = "dev-ongi-cdn-forwarding-rule"
# }
